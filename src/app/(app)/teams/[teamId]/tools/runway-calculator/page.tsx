...
export default async function RunwayCalculatorPage({ params }: { params: Promise<{ teamId: string }> }) {
  ...
  return (
    <ToolLayout icon={TrendingDown} title="Runway Calculator" description="Track your burn rate, cash on hand, and how long you have left. Runway is time to learn — protect it." teamId={teamId} artifactType="runway_calculator" platformRole={ctx.effectiveRole} currentUserId={ctx.user.id} adminNotes={ctx.adminNotes} mentorNotes={ctx.mentorNotes}>
